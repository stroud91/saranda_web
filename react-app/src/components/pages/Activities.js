...
const Activities = () => {
  const cardsData = [
    ...
    { title: 'Activity 4', description: 'Description 4', image: '/path-to-image4.jpg' },
    { title: 'Activity 5', description: 'Description 5', image: '/path-to-image5.jpg' },
    { title: 'Activity 6', description: 'Description 6', image: '/path-to-image6.jpg' },
  ];
